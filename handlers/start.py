...
def _guide_text() -> str:
    return (
        ...
        f"🍽 <b>غذا</b>\n"
        f"بنویس «غذا» تا وقتی جوجوت گرسنه شد، با یه دکمه سیرش کنی.\n\n"
        f"🏭 <b>کارخونه</b>\n"
        f"بنویس «کارخونه» تا محصول تولید کنی، انبار کنی و بفروشی.\n\n"
        f"🏙 <b>شهر</b>\n"
        f"بنویس «شهر» تو گروه تا به خزانه‌ی مشترک کمک کنی و شهر رو ارتقا بدید.\n\n"
        f"🚚 <b>قاچاق</b>\n"
        f"بنویس «قاچاق» تا با ریسک، جوجه قاچاق کنی و جایزه بگیری.\n\n"
        f"🪪 <b>پروفایل</b>\n"
